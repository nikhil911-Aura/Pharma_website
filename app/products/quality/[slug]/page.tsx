...
const productPages: Record<string, React.ComponentProps<typeof ProductDetailPage>> = {
  ...
  "cleaning-validation": {
    ...
    faqs: [
      { question: "What is Cleaning Validation and how does it automate cleaning validation?", answer: "Cleaning Validation is SYNCOMX's cleaning validation software that automates HBEL-based residue limit calculations, worst-case product identification, and validation protocol generation. It eliminates manual spreadsheets and ensures consistent, defensible cleaning validation documentation." },
